...
import "../fonts/maiden.ttf";

export default function Home() {
  return (
    <div class="martop">
      <div class=" font-face-md bg-gold_pre text-black-pre ">
        {/* <Header /> */}

        <div id="intro" class="flex items-center h-screen ">
          <img
            src={Rutik}
            class="border-4 border-silver_pre rounded-full  w-80 h-80 mx-20"
            alt="Rutik"
          />
          <div class="  font-face-md text-center GS  w-50 mx-20">
            <blockquote>
              <p class=" font-face-md  text-7xl font-large ">
                <Typist>
